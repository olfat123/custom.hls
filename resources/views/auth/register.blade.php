            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="signup-link">Get started with an <br /> account</h1>
                            ...
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="last_name" type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name" value="{{ old('last_name') }}"
                                     required autocomplete="last_name" placeholder="Last Name" autofocus>
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}"
                                     required autocomplete="phone" placeholder="Phone" autofocus>
                                ...
                                <div class="n-chk">
                                    <label class="new-control new-radio radio-success letter-dark">
                                        <input type="radio"  class="new-control-input @error('USERGROUPID') is-invalid @enderror" 
                                               checked="checked" value="3" name="USERGROUPID">
                                        <span class="new-control-indicator"></span>User Account
                                    </label>
                                </div>
                                <br>
                                <div class="n-chk">
                                    <label class="new-control new-radio radio-success letter-dark">
                                        <input type="radio" class="new-control-input @error('USERGROUPID') is-invalid @enderror" value="4" 
                                                  name="USERGROUPID">
                                        <span class="new-control-indicator"></span>Group Account
                                    </label>
                                </div>
                                ...
                                <!-- <div class="d-sm-flex justify-content-between">
                                    ...
                                    <div class="field-wrapper">
                                        <button type="submit" class="btn btn-primary bg-blue" value="">Get Started!</button>
                                    </div>
                                </div> -->
