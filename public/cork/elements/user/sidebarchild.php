...
<!-- 
                <div class="submenu" id="accounts">
                    <ul class="submenu-list" data-parent-element="#accounts">
                    <li class="sub-submenu">
                            <a role="menu" class="collapsed" data-toggle="collapse" data-target="#singleaccounts" aria-expanded="false">
                                <div>
                                    <span class="icon">
                                    ...
                                    </span> Single Accounts
                                </div> 
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right">
                                    <polyline points="9 18 15 12 9 6"></polyline>
                                </svg> 
                            </a>
                            <ul id="singleaccounts" class="collapse" data-parent="#compact_submenuSidebar">
                                <li>
                                    <a href="addaccount.php"> Add Account </a>
                                </li>
                                <li>
                                    <a href="#"> Active Accounts </a>
                                </li>
                                <li>
                                    <a href="#"> Inactive Accounts </a>
                                </li>
                                <li>
                            </ul>
                    </li>
                    <li class="sub-submenu">
                            <a role="menu" class="collapsed" data-toggle="collapse" data-target="#companysaccounts" aria-expanded="false">
                                <div>
                                    <span class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle">
                                        <circle cx="12" cy="12" r="10"></circle>
                                        </svg>
                                    </span> Companys Accounts
                                </div> 
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right">
                                    <polyline points="9 18 15 12 9 6"></polyline>
                                </svg> 
                            </a>
                            <ul id="companysaccounts" class="collapse" data-parent="#compact_submenuSidebar">
                                <li>
                                    <a href="addcompany.php"> Add Company </a>
                                </li>
                                <li>
                                    <a href="#"> Active Companys </a>
                                </li>
                                <li>
                                    <a href="#"> Inactive Companys </a>
                                </li>
                            </ul>
                    </li>
                    </ul>
