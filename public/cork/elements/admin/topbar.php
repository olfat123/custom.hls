            ...
            <ul class="navbar-item flex-row">
                <li class="nav-item theme-logo">
                    <a href="index.html">
                        ...
                        <img src="library/logos/HLSprofessionalLearning.jpg" class="navbar-logo" alt="logo" style="max-width: 100px; min-width: 100px; height: auto !important;">
                    </a>
                </li>
            </ul>
                    ...
                    <div class="dropdown-menu position-absolute animated fadeInUp" aria-labelledby="userProfileDropdown">
                        ...
                        <div class="dropdown-item">
                            <a href="register.php">
                                ...
                                </polyline><path d="M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z">
                                </path>
                                </svg> 
                                <span>Register</span>
                            </a>
